"""
Beta boxplots (Gini and cost components) from evaluation outputs.

Usage:
    uv run beta/plots/boxplots.py --categories 5
...
ax.fill_between(
    [0.5, 11.5], mean - 1.96 * std_dev, mean + 1.96 * std_dev, color="gold", alpha=0.2
)
# Using a single custom color
box_color = sns.color_palette("viridis", 11)[2]
# Creating the boxplot with custom settings
